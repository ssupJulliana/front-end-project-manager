...
import CreateTasksOral from './createtasksoral'; // Ensure this matches the file name exactly
  ...
  const [tasks, setTasks] = useState([
    {
      id: 1,
      assigned: 'Team A',
      task: 'Prepare PowerPoint slides',
      dateCreated: 'Dec 10, 2025',
      dueDate: 'Dec 12, 2025',
      time: '10:00', // time in 24-hour format for easier comparison
      methodology: 'Oral Presentation Phase',
    ...
    },
    {
      id: 2,
      assigned: 'Team B',
      task: 'Finalize Research Paper',
      dateCreated: 'Dec 21, 2025',
      dueDate: 'Dec 25, 2025',
      time: '15:00', // time in 24-hour format for easier comparison
  ...
  return (
    <div style={{ margin: '40px auto', maxWidth: '95%' }}>
      <div style={{ fontSize: '20px', fontWeight: '600', color: '#5c0000' }}>
        Tasks » <span style={{ color: '#000' }}>Oral Defense</span>
      </div>
      ...
      {/* Show CreateTasksOral modal if showCreateTask is true */}
      {showCreateTask && (
        <CreateTasksOral
