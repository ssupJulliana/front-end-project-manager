// src/components/tasks/title-defense-tasks.jsx
import React, { useState, useEffect, useRef } from "react";
import TitleCreateTasks from "./title-create-tasks";
import taskIcon from "../../assets/tasks-icon.png";
import createTasksIcon from "../../assets/create-tasks-icon.png"; // New icon import
...
const TitleDefenseTasks = () => {
  ...
  return (
    <div className="page-wrapper">
      ...
      {/* New header wrapper with Create Task button and tasks container */}
          ...
          <table className="tasks-table">
            <thead>
              <tr>
                ...
                <th className="center-text">Methodology</th> {/* NEW COLUMN */}
            ...
            <tbody>
              <tr>
                ...
                <td className="center-text">{/* Methodology cell */}Qualitative</td>
      ...
      <style>{`
        * {
        ...
        /* New wrapper for button + tasks container */
        .header-wrapper {
          display: flex;
          gap: 20px;
        ...
        .create-task-button {
          ...
          font-weight: 600;
          cursor: pointer;
          height: 34px; /* smaller than search/filter */
          user-select: none;
          flex-shrink: 0;
